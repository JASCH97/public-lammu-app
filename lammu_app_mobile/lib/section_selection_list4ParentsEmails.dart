...
import 'package:lammu_app/send_parents_emailsBySection.dart';

class SectionSelectionList4ParentsEmails extends StatefulWidget {
  const SectionSelectionList4ParentsEmails({super.key});
  @override
  State<SectionSelectionList4ParentsEmails> createState() => _SectionSelectionList4ParentsEmailsState();
}

class _SectionSelectionList4ParentsEmailsState extends State<SectionSelectionList4ParentsEmails> {
  List<String> section = [];
  ...
  void getSectionList() async {
    ...
    if (yearValue == "Ninguno" || sectionValue == "Ninguno") {
      ...
      if (listOfStudentsBySection.isEmpty) {
        ...
        final route =
        MaterialPageRoute(builder: (context) => SendSectionParentsEmails());
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          Center(
                            child: Center(
                              child: Text(
                                " Ingrese la sección de la que desea enviar un comunicado a todos los padres de familia o tutores legales:",
                                style: TextStyle(
