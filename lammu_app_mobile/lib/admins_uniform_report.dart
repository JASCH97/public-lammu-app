...
class AdminsUniformReport extends StatefulWidget {
  const AdminsUniformReport({super.key});
  @override
  State<AdminsUniformReport> createState() => _AdminsUniformReportState();
}

class _AdminsUniformReportState extends State<AdminsUniformReport> {
  ...
  Future sendEmail() async {
    ...
    final Email email = Email(
      body: 'Hola! Este es un mensaje automático generado por la aplicación del Liceo de Atenas "LAMMU".\n\nLos siguientes estudiantes de la sección $finalSection incumplen con el reglamento del uniforme el día de hoy:\n$students\n\nReporte generado por:  \n\nSaludos.',
      subject: 'Reporte de uniforme incompleto',
        ...
        AlertDialog(
          ...
          actions: [
            ...
            TextButton(onPressed: () {
              ...
              child: const Text(
                'SÍ', textAlign: TextAlign.right, style: TextStyle(
                  fontWeight: FontWeight.bold,
                  fontSize: 24,
                  color: Colors.blue),),)
          ],
  ...
  Future<dynamic> backToSelectSection() {
    return showDialog(context: context, barrierDismissible: false, builder: (context) => AlertDialog(
      title: const Text('Si se devuelve ahora, no se enviará el reporte de uniforme incompleto al auxiliar, orientador y profesor guía\n\nDesea devolverse igualmente?', style: TextStyle(
          fontWeight: FontWeight.bold,
          fontSize: 26,
          color: Colors.black),
      ),
          ...
          child: Center(
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  Text(
                    "A continuación se enviará un reporte de uniforme incompleto de la sección $finalSection por correo electrónico a:\n\n-Auxiliar\n-Orientador\n-Profesor Guía",
                    style: TextStyle(
