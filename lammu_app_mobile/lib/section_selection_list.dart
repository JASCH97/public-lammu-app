...
class SectionSelectionList extends StatefulWidget {
  const SectionSelectionList({super.key});
  @override
  State<SectionSelectionList> createState() => _SectionSelectionListState();
}

class _SectionSelectionListState extends State<SectionSelectionList> {
  List<String> section = [];
  ...
  void getSectionList() async {
    ...
    if (yearValue == "Ninguno" || sectionValue == "Ninguno") {
      ...
      if (listOfStudentsBySection.isEmpty) {
        ...
        final route =
        MaterialPageRoute(builder: (context) => const CheckListBySection());
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Center(
                                child: Text(
                                  " Ingrese la sección de la que desea pasar lista:",
                                  style: TextStyle(
