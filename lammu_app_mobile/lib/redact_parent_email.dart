...
class RedactParentEmail extends StatefulWidget {
  //static String id = 'login_page';
  //static String? fullName = _RedactParentEmailState()._userNameController.text;
  @override
  State<RedactParentEmail> createState() => _RedactParentEmailState();
}

class _RedactParentEmailState extends State<RedactParentEmail> {
  bool isButtonPressed = false;
  String studentName = studentInformation[0];
  String tutorName = studentInformation[6];
  String tutorEmail = studentInformation[7];
  // text controllers
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Text(
                  "Se enviará un correo electrónico al padre de familia o tutor legal del estudiante: $studentName\n\nPara su información, el nombre del padre de familia o tutor legal es: $tutorName",
